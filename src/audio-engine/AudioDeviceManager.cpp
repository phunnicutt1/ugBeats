...
juce::StringArray AudioDeviceManager::getAvailableDeviceNames() const
{
    ...
    // Cast away const for this method call
    auto& deviceTypes = const_cast<UndergroundBeats::AudioDeviceManager*>(this)->getAvailableDeviceTypes();
...
void AudioDeviceManager::audioDeviceError(const juce::String& errorMessage)
{
    ...
    // Since we can't override audioDeviceError, we don't call any base implementation here
}
