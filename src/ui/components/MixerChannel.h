...
private:
    ...
    struct SendControl {
        ...
        // Enable moving
        SendControl(SendControl&& other) noexcept = default;
        SendControl& operator=(SendControl&& other) noexcept = default;
        
        // Disable copying
        SendControl(const SendControl&) = delete;
        SendControl& operator=(const SendControl&) = delete;
    };
