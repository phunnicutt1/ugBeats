 ...
 */
class Oscillator : public ProcessorNode {
public:
    Oscillator();
    virtual ~Oscillator();
    ...
    /**
     * @brief Set the oscillator's pulse width (for square/pulse waveforms)
     * 
     * @param width Pulse width (0.0 to 1.0)
     */
    ...
    /**
     * @brief Set the oscillator's detune amount
     * 
    ...
    /**
     * @brief Set the oscillator's gain
     * 
     * @param gain Gain amount (0.0 to 1.0)
     */
